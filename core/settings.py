...
# SIMPLE_JWT = {
#     'ACCESS_TOKEN_LIFETIME': timedelta(minutes=settings.CONSTANCE_CONFIG['ACCESS_TOKEN_LIFETIME'][0].total_seconds() / 60),
#     'REFRESH_TOKEN_LIFETIME': timedelta(days=settings.CONSTANCE_CONFIG['REFRESH_TOKEN_LIFETIME'][0].days),
