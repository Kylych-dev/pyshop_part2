...
class RegisterView(viewsets.ViewSet):
    ...
    @swagger_auto_schema(
        ...
        request_body=openapi.Schema(
            ...
            properties={
                'email': openapi.Schema(type="string", format='email', description='Email пользователя'),
                'password': openapi.Schema(type="string", format='password', description='Пароль пользователя')
            },
        ),
        responses={
...
class AuthenticationView(viewsets.ViewSet):
    ...
    @swagger_auto_schema(
        ...
        request_body=openapi.Schema(
            ...
            properties={
                'refresh_token': openapi.Schema(type="string", description='Токен обновления пользователя')
            },
        ),
        responses={
...
class UserView(APIView):
    ...
    @swagger_auto_schema(
        ...
        #     required=['id'],
        #     properties={
        #         'id': openapi.Schema(type="integer", description='ID пользователя'),
        #     },
        # ),
        responses={
    ...
    @swagger_auto_schema(
        ...
        request_body=openapi.Schema(
            ...
            properties={
                'email': openapi.Schema(type="string", format='email', description='Новый email пользователя'),
                'username': openapi.Schema(type="string", description='Новое имя пользователя')
            },
        ),
